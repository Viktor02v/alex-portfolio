import { a as getHash, c as setHash, i as dataMediaQueries, l as slideDown, n as bodyLockToggle, o as gotoBlock, r as bodyUnlock, s as isMobile, t as bodyLockStatus, u as slideUp } from "./common.min.js";
		...
		if (e.type === "click") {
			...
			if (targetElement.closest("[data-fls-scrollto]")) {
				...
				if (window.flsFullpage) {
					const scrollTarget = document.querySelector(`${gotoLinkSelector}`);
					const fullpageSection = scrollTarget ? scrollTarget.closest("[data-fls-fullpage-section]") : null;
					const fullpageSectionId = fullpageSection ? +fullpageSection.dataset.flsFullpageId : null;
					if (fullpageSectionId !== null && !Number.isNaN(fullpageSectionId)) {
